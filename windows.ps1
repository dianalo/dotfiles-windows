...
# Set Computer Name
(Get-WmiObject Win32_ComputerSystem).Rename("Loris-ZenBook") | Out-Null
...
Set-ItemProperty "HKLM:\SOFTWARE\Microsoft\WcmSvc\wifinetworkmanager\config" "AutoConnectAllowedOEM" 1
